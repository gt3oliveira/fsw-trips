...
const userData: Prisma.TripCreateInput[] = [
    {
        name: "Hotel Aurora",
        description:
...
export async function main() {
    for (const u of userData) {
        await prisma.trip.create({ data: u });
    }
}
